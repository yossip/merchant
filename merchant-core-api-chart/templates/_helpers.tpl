...
helm.sh/chart: {{ include "merchant-core-api-chart.chart" . }}
{{ include "merchant-core-api-chart.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
app.kubernetes.io/name: {{ include "merchant-core-api-chart.name" . }}
...
{{- default (include "merchant-core-api-chart.fullname" .) .Values.serviceAccount.name }}
{{- else }}
